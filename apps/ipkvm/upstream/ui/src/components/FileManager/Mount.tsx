import { PlusCircle, AlertTriangle, Trash2 } from "lucide-react";
              ...
              <div className="w-full px-4 py-12">
                <div className="flex h-full flex-col items-center justify-center text-center">
                  {selectedFile ? (
                    ...
                    <div className="space-y-1">
                      <PlusCircle className="mx-auto h-6 w-6 text-blue-700" />
                      <h3 className="text-sm leading-none font-semibold">
          ...
          {onStorageFiles.length === 0 ? (
            <div className="flex items-center justify-center py-8 text-center">
              <div className="space-y-3">
                <div className="space-y-1">
                  <PlusCircle className="mx-auto h-6 w-6 text-blue-700 dark:text-blue-500" />
                    ...
                    {uploadState === "idle" && (
                      <div className="space-y-1">
                        <div className="inline-block">
                          <Card>
                            <div className="p-1">
                              <PlusCircle className="h-4 w-4 shrink-0 text-blue-500 dark:text-blue-400" />
                            </div>
                          </Card>
                        </div>
                        <h3 className="text-sm leading-none font-semibold text-black dark:text-white">
