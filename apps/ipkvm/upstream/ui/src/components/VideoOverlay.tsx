                  ...
                  <div className="space-y-2 text-black dark:text-white">
                    <AntdCard className={`${dark_bg_style} ${dark_bd_style}`}>
                      <ul className="list-disc space-y-2 pl-4 text-left">
                        ...
                        <li>
                          {$at("Make sure the ")}
                          <span className="text-[red]">{$at("BaiwenKVM ")}</span>
                        ...
                        <li>
                          {$at("Verify that ")}
                          <span className="text-[red]">{$at("BaiwenKVM's ")}</span>
...
export function PointerLockBar({ show, onActivate }: PointerLockBarProps) {
  const { $at } = useReactAt();
  return (
      ...
      {show ? (
        ...
        >
          <button
            type="button"
            onClick={onActivate}
            className="cursor-pointer rounded-b-md text-left focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
            data-testid="enable-kvm-input"
          >
