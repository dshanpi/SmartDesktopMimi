...
# 3. 正式发布：预检后，一键干净重编全部应用 + SDK build/pack + 验收归档
./scripts/build_release.sh --check-only /home/ubuntu/A133-Tina5.0-v0.9
./scripts/build_release.sh              /home/ubuntu/A133-Tina5.0-v0.9
```
